...
public class CommandFoodStationCollide extends Command {

	// Create a private GameWorld object so we can manipulate the one that is given in the constructor
	private GameWorld gw;
	
	// Constructor
    public CommandFoodStationCollide(GameWorld gw) {
    ...
    public void actionPerformed(ActionEvent e) {
    	...
    	// Call the collisionFoodStation() method on the GameWorld (gw) object
