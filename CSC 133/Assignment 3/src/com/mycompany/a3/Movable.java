...
public abstract class Movable extends GameObject {
	...
	public void move (int tickRate) {		
		...
		float deltaX = (float) (Math.cos(radians) * getSpeed() * tickRate/1000);
		float deltaY = (float) (Math.sin(radians) * getSpeed() * tickRate/1000);
	...
	public void checkBoundary(int width, int height, int tickRate) {		
